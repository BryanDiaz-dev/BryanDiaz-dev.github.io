    ...
    <nav className='bg-[#151515] shadow-lg border-b border-[#6d28d9]/10 fixed w-full top-0 z-50'>
      <div className='container mx-auto px-4'>
        <div className='flex justify-between items-center h-16'>
          ...
          <div className={`absolute top-16 left-0 w-full md:relative md:top-0 md:w-auto bg-[#151515] md:bg-transparent ${isOpen ? 'block' : 'hidden'} md:block`}>
            <div className='flex flex-col md:flex-row md:space-x-8 space-y-4 md:space-y-0 p-4 md:p-0'>
              ...
              <button onClick={() => scrollToSection('tecnologias')} className='text-[#8b5cf6] hover:text-[#7c3aed] transition-colors text-left'>
                Tecnologias
              </button>
